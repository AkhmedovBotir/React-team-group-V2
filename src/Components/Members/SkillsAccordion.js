    ...
    return (
        <>
            ...
            <div className="accordion accordion-flush d-flex flex-row justify-content-between flex-wrap" id="accordionFlushExample">
                <div className="accordion-item w-25 bg-transparent m-5 border-0">
                ...
                <div className="accordion-item w-25 bg-transparent m-5 border-0">
                    <h2 className="accordion-header" id="flush-headingTwo">
                        <div className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
                            <ConstructionIcon className="icon" style={{ fill: 'black', width: '20px', height: 'auto' }} />
